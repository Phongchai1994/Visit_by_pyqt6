...
class Spacial_Report(QWidget):
    def __init__(self):
        super().__init__()
        self.db = POSTGRESQL()

        self.setObjectName('Spacial_Report')
        ...
        # หัวข้อ
        title_label = QLabel('รายงานการเยี่ยมวันหยุดพิเศษ')
        title_label.setObjectName('Spacial_Report_title_label')
